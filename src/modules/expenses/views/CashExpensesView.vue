              ...
              <th>
                <span class="flex gap-2"
                  >Fecha<SortIcon
                    ...
                    @click="expenseStore.sortExpenses('cashExpenses', 'date')"
                /></span>
              </th>
              <th>
                <span class="flex gap-2"
                  >Concepto<SortIcon
                    class="cursor-pointer"
                    @click="expenseStore.sortExpenses('cashExpenses', 'description')"
                /></span>
              </th>
              <th>
                <span class="flex gap-2"
                  >Categoría<SortIcon
                    class="cursor-pointer"
                    @click="expenseStore.sortExpenses('cashExpenses', 'category')"
                /></span>
              </th>
              <th>
                <span class="flex gap-2"
                  >Pagador<SortIcon
                    class="cursor-pointer"
                    @click="expenseStore.sortExpenses('cashExpenses', 'payer')"
                /></span>
              </th>
              <th>
                <span class="flex gap-2"
                  >Importe<SortIcon
                    class="cursor-pointer"
                    @click="expenseStore.sortExpenses('cashExpenses', 'amount')"
                /></span>
              </th>
              <th>Acciones</th>
            </tr>
